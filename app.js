...
function sum(a, b){
  ...
  return [sum, message]; //eslint-disable-line
}
...
function multiply(a, b){
  ...
  console.log(multiply, message);
  return [multiply, message] //eslint-disable-line
}
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var multiplyThree = multiply(multiplyTwo, c)[0];
  var messageA = a + ' and ' + b + ' and ' + c + ' sum to ' + sumThree + '.';
  var messageB = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplyThree + '.';
  console.log(sumThree, multiplyThree, messageA, messageB);
  return [sumThree, multiplyThree, messageA, messageB];
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var arraySumTwo = sum(arraySum, testArray[2])[0];

  console.log(testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + arraySumTwo + ' is their sum.');

  return [arraySumTwo, testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + arraySumTwo + ' is their sum.'];
...
var multiArray = multiply(testArray[0], testArray[1])[0];
var multiArrayTwo = multiply(multiArray, testArray[2])[0];

console.log('The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + multiArrayTwo + '.');
return [multiArrayTwo, 'The numbers ' + testArray + ' have a product of ' + multiArrayTwo + '.'];
}
